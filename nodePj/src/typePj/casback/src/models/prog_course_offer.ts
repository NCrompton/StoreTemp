...
export type prog_course_offerOptionalAttributes =
...
export type prog_course_offerCreationAttributes = Optional<
	prog_course_offerAttributes,
	prog_course_offerOptionalAttributes
>

export class prog_course_offer
	extends Model<prog_course_offerAttributes, prog_course_offerCreationAttributes>
	implements prog_course_offerAttributes
{
	prog_course_offer_id!: number
	programme_id!: number
	course_id!: number
				...
				indexes: [
					{
						...
						unique: true,
						fields: [{ name: "prog_course_offer_id" }],
					},
				],
			}
		)
