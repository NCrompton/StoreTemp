...
export type course_detailOptionalAttributes = "course_detail_id" | "name" | "credit" | "duration" | "level" | "medium" | "cw_percent" | "exam_percent" | "exam_duration" | "precursor" | "prerequisite" | "equivalent" | "exclusive" | "fund_mode" | "cef_course" | "block_transfer" | "remark" | "version" | "is_current" | "date_created" | "date_modified" | "grade_pattern" | "cohort_from" | "cohort_to" | "aim" | "grade_remark" | "kw_syllabus" | "syllabus" | "u_name" | "r_host" | "web_logon_name" | "web_logon_host" | "text_reading" | "online_reading" | "semester_id" | "equivalent_old";
export type course_detailCreationAttributes = Optional<course_detailAttributes, course_detailOptionalAttributes>;

export class course_detail extends Model<course_detailAttributes, course_detailCreationAttributes> implements course_detailAttributes {
  course_detail_id!: number;
  course_id!: number;
  name?: string;
  credit?: number;
