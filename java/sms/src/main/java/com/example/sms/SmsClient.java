...
public class SmsClient extends WebServiceGatewaySupport{
        ...
        public SendEngSMSResponse sendSms(){
            ...
            //SendEngSMSResponse response = (SendEngSMSResponse) getWebServiceTemplate().marshalSendAndReceive("https://cap.cityu.edu.hk/sms/cityusms.asmx", request, new WebServiceMessageCallback() {
            SendEngSMSResponse response = (SendEngSMSResponse) getWebServiceTemplate().marshalSendAndReceive("http://localhost:5000/s", request, new WebServiceMessageCallback() {
